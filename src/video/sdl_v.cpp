...
#if !defined(__UBPORTS__) // Android has native screen sizes first, do not sort them
		SortResolutions();
#endif
	}
}
...
#ifndef __UBPORTS__ // No mouse warping on Android, mouse strictly follows finger
